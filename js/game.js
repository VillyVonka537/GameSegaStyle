;(function() {
	...
	// 	//один раз обновилось
	// 	self.update(gameSize);
	// 	//один раз отрисовалось
	// 	self.draw(screen, gameSize);
	// 	//частота кадров - стандартная функци (30-60 кадров по стандарту)
	// 	//реквестанимайшонфрейм - родная функция яваскрипт - у нас еще и рекурсиваня что лочно
	// 	requestAnimationFrame(tick);
	// }
	// //вызываем функцию
	// tick();
	// }
	//функции посредством цикла
	Game.prototype = {
